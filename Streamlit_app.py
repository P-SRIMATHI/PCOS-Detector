...
with col2:
    # Display prediction results and alerts
    ...
    if st.session_state.health_points >= 50:
        ...
        st.write("Congratulations! You've earned a reward badge!")
        # Simulate reward or badge (can use a real image URL here)
        st.image("https://example.com/your_badge_image.png", caption="Your Health Champion Badge")
